...
\marginnote{A doble t{[}ra{]}ce}lis od{[}er{]} iij bak the first od{[}er{]} iij bake\\
...
\marginnote{Doble t{[}ra{]}ce}then torne all at onys
...
\marginnote{whith t{[}ra{]}ce}torne othir Abought \^{}ii; \marginnote{2}\red{t}hen brayl\\
