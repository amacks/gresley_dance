...
\srcpg{54}    
\marginnote{Esp{[}er{]}ans de 3{[}bus{]}} Al the vj si{[}n{]}glis w{[}ith{]} a trett; þen þe \\* 
...
\srcpg{56} 
all trett and retrett w{[}ith{]} \marginnote{with t{[}ra{]}ce}halfe a t{[}or{]}ne \\ 
...
\srcpg{60}
\marginnote{3} whill \^{} \textsuperscript{þe 2{[}d{]}} t{[}or{]}ne rake and retrett and þ{[}e{]}\\
...
\marginnote{What so eu{[}er{]} y wyll de 2 b{[}us{]}}Afrer the end of the t{[}ra{]}ce trett 
\srcpg{62}
And retrett to geders and thre for-\\
th forth w{[}ith{]} A step; \red{t}hen trett \& retrett\\
to geder \marginnote{$\frac{2}{1}$}and both torne at onys;\\
\red{t}hen both forth to ged{[}er{]} w{[}ith{]} vi \marginnote{$\frac{2}{4}$}sing=\\
lis and \red{t}hen change hands \red{t}hen\\
Forth w{[}ith{]} od{[}er{]} sex \marginnote{$\frac{1}{1}$}singlis \& change\\
hands; \red{t}hen trett \& retrettt at onys\\
then rake both at onys

\subsection{Petygay}
\marginnote{Petygay de 3{[}bus{]}}After þe\\
end of the tr{[}ac{]}e ev{[}er{]}y ma{[}n{]} ii{[}i{]} singlis\\
after od{[}er{]}; \marginnote{Doble t{[}ra{]}ce}\red{t}hen þe doble trace Agayn\\
then torne all at onys

\subsection{Tamrett}
\marginnote{Ta{[}m{]}rett De doubus}After\\
\marginnote{2}the end of the trace trett \& retret\\
and iij forth to ged{[}er{]}; \red{t}hen trett\\
\& retrett and iij bake then ethir\\
torne othir Abought \^{}ii; \marginnote{2}\red{t}hen brayl\\
ethir {[}con{]}t{[}ra{]}ry to od{[}er{]} ij tymes \marginnote{whith t{[}ra{]}ce}\red{\&} retrett\\
iij other fro od{[}er{]} \& then com toged{[}er{]}\marginnote{1}

\subsection{Green Gynger}
\marginnote{Grengy{[}n{]}g{[}er{]} de doub{[}us{]} Duble t{[}ra{]}ce w{[}ith{]} a hertt in the end}After þe end of þe t{[}ra{]}ce rak both
\srcpg{63}
on way and iij the end t{[}or{]}ne bak to\\
bak; \red{t}hen rake ayen bak to bake\\
and in the end torne face to face\\
then iij singlis ethir {[}con{]}t{[}ra{]}ry\marginnote{Cherwell thy wyne} od{[}er{]} \&\\
thre bak Ayen; \red{t}hen ethir retrett\\
\marginnote{$\frac{2}{3}$}from \^{}odir iij singlis; \red{t}hen come toged{[}er{]}\\
and mak a hertt Ayen\marginnote{1}
