...
\marginnote{Temp{[}er{]}ans} All trett and retrett thre singlis\\
w{[}ith{]} a stop then þe first and þ{[}e{]} me=\\
dyll togedd{[}er{]} retrett; while þe\\
last goth \marginnote{Trace}forth and cu{[}m{]} togedd{[}er{]}\\
...
\marginnote{Northhu{[}m{]}bland de 3{[}bus{]}}Togedd{[}er{]} thre si{[}n{]}g=\\
lis w{[}ith{]} a stop trett and retrett;\\
then þe first \sout{þ} ma{[}n{]} torn in hys\\
own place whill the last \marginnote{Trace}torn\\
