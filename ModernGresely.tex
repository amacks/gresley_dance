...
\marginnote{Trace}come behend whil þe medyll \\ 
retrett thre and þe last iij singlis \\ 
and þe \marginnote{3}medil iij singlis levyng\\ 
...
ev{[}er{]}y man as he \marginnote{3}standdith; \red{A}ft{[}er{]} þe\\
end of the t{[}ra{]}ce þe ferst iij fur-\\
th outward t{[}ur{]}nyng Ayen his \\ 
face; then þe  \marginnote{1}last co{[}n{]}tur hym \\ 
and the medill to þe fyrste \& \\
then þe first to his place; \red{y}en \\ 
the i last to the \marginnote{1}medyll and þe  
\srcpg{55}
...
\marginnote{doble t{[}ra{]}ce}hyme and \marginnote{2}t{[}ur{]}ne face to face; \red{t}hen \\ 
...
\subsection{Egle}
All to gedir trett \& \\ 
\marginnote{{[}Egle{]}\\ de 3bs}retrett then iij singlis forth \\
\ 
\srcpg{57}
then the medill torne into þe first \\ 
manys place befor hym; þe first in-\\
to þe medils manys place whil þe \\
\marginnote{Trace 3}last Brawlyth; \red{t}hen trett and retrett \\
...
\marginnote{Whith t{[}ra{]}ce}face to face met in to a t{[}ri{]}angle \\
...
\marginnote{A doble tr{[}ac{]}e}first torne the first lepe þe last\\
...
\marginnote{The t{[}ra{]}ce}the end of þe trace rak both to-\\
...
\marginnote{Princitore\\ de duob{[}u{]}}After þe\\
end of þe trace A longe torne both\\
at onys; \red{t}hen þe first ma{[}n{]} iij forth\\
\marginnote{Whith t{[}ra{]}ce}and þe od{[}er{]} iij bak and then loke\\
...
\marginnote{Grengy{[}n{]}g{[}er{]}\\ de doub{[}us{]}}After þe end of þe t{[}ra{]}ce rak both
\srcpg{63}
\marginnote{Duble t{[}ra{]}ce w{[}ith{]}\\ a hertt in the\\ end}\ 

on way and iij the end t{[}or{]}ne bak to\\
bak; \red{t}hen rake ayen bak to bake\\
\marginnote{Cherwell\\ thy wyne}and in the end torne face to face\\
...
\subsection{Lybens}
\marginnote{Lebens di\\ {[}{]}nens de 2{[}bus{]}}After the end of þe t{[}ra{]}ce the\\
first iij forth and torne whill the
\srcpg{64}
\red{S}ec{[}o{]}nd retrett iij bake then com to\\
ged{[}er{]} and\marginnote{a\textsuperscript{n}} ethir torne into oders\\
...
the same; \red{t}hen al togeder halfe\\
 \marginnote{A doble tr{[}ac{]}e}torne thre tymes; \marginnote{$\frac{3}{3}$}\red{t}hen the last\\
...
\marginnote{A doble t{[}ra{]}ce\\ \& iij bak i{[}n{]} þ{[}e{]} en{[}d{]}}the sec{[}o{]}nd the same þe iij the sam\\
...
\marginnote{A doble t{[}ra{]}ce\\ \& lok at þ{[}e{]} end\\ bak and al\\ to{[}ge{]}d{[}er{]} do obbey}3\textsuperscript{d} the same; \red{t}hen {[}þe{]} first man\\
...
\marginnote{Suff}the last torne whils þe first retrett;\\
then þe first aflo{[}ur{]} delice þe 2\textsuperscript{e} þe\\
\marginnote{a dubull t{[}ra{]}ce}same; then thre singlis a þ\textsuperscript{e} {[}con{]}tra to od{[}er{]};
\srcpg{68}
...
\subsection{Damesyn}
\marginnote{Damesyn\\ de 3b{[}us{]}}All togedd{[}er{]} thre singlis w{[}ith{]} {t{[}ra{]}ce}\footnote{"trace" appears in the margin, has been moved into the text}\\
...
\marginnote{A dubel {[}trace{]}}in þe sam wis agayn; then trett\\
...
\marginnote{Temp{[}er{]}ans\\ de 3b{[}u{]}} All trett and retrett thre singlis\\
...
\marginnote{Trace}dep{[}er{]}tytt þe secnd shall þe thred\\
...
\marginnote{Northhu{[}m{]}b\\land de 3{[}bus{]}}Togedd{[}er{]} thre si{[}n{]}g=\\
lis w{[}ith{]} a stop trett and retrett;\\
then þe first \sout{þ} ma{[}n{]} torn in hys\\
\marginnote{Trace}own place whill the last torn\\
