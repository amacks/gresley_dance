...
\newcommand{\srcpg}[1]{
    \noindent{
        \hspace{-0.65in}\color{Gray}{\rule[0.5ex]{5.5in}{1pt}~#1} 
    }
}
% oriented margin notes
\newcommand{\tmn}[1]{% Text Margin Note
...
\srcpg{62}
\tmn{Doble t{[}ra{]}ce}\ \\
\nmn{2}And retrett to geders and thre for-\\
...
\tmn{Sofferance\\ de duob{[}us{]}}After\\
...
first iij forth and torne\footnote{Corrected in the bottom margin} whill the \\
\srcpg{64}
...
\\ \ \\
\srcpg{65}
The first thre forth þe \tmn{Double t{[}ra{]}}sec{[}o{]}nd þe\\
...
\nmn{3\textsuperscript{a}}After the end of the t{[}ra{]}ce þe firste\\
...
\subsection{Roye}
\tmn{Roye de 3 b{[}us{]}}After the end of þ{[}e{]}\\
...
\subsection{Orange}
\tmn{Oringe\\ de 3 b{[}us{]}}After the end of þe trace the\\
...
thre forth the \nmn{3} fi{[}r{]}st þe same þe 2\textsuperscript{d}\\
þe sam \& the \nmn{3}3\textsuperscript{d} throth þa{[}m{]} \& goo\\
behynd; \red{t}hen þe first iij \nmn{3}bak þ{[}en{]}\\
þe secn{[}o{]}d iij bak; \red{t}hen all toged{[}er{]}\\
