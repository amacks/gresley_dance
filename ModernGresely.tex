...
\marginnote{Sofferance de duob{[}us{]}}After\\
the end of þe trace the first iij\\
forth and torne whyll þe last \\
\marginnote{A doble t{[}ra{]}ce}retrett; \red{t}hen the last forth \&\\ 
torne whyll þe first retrett\\
and then\marginnote{3} both retrett ethir\\
from od{[}er{]}; \red{t}hen the first a flowr\\
delice the\marginnote{2} sec{[}o{]}nd Anothir; \red{t}hen\\
ethir {[}con{]}tr{[}a{]}ry other iij singlis\marginnote{3} on þ{[}e{]}\\
left syd \red{a}nd then come to ged{[}er{]}\\
then trett and retrett and torn\marginnote{2}

\subsection{Lybens}
\marginnote{Lebens dis {[}{]}nens de 2{[}bus{]}}After the end of þe t{[}ra{]}ce the\\
first iij forth and torne whill the
\srcpg{64}
\red{S}ec{[}o{]}nd retrett iij bake then com to\\
ged{[}er{]} and\marginnote{A\^{}n} ethir torne into oders\\
plas; \red{t}hen last ma{[}n{]} iij forth \& torn\\
whill\marginnote{2} þe first retrett; \red{t}hen come to\\
ged{[}er{]} in suchwys as þay ded Afore\marginnote{1}\\
and ethir end in ther own place\\
then trett and retrett and torn

\subsection{Aras}
\marginnote{Aras de 2{[}obus{]}}\red{A}fter the end of the trace rak\\
both on way; \red{t}hen the first ma{[}n{]}\\
\marginnote{2}torne whill þe sec{[}o{]}nd retrett; \red{þ}en\\
...
\subsection{Eglamore}
\marginnote{Eglamowr de trib{[}us{]}}After the end of the tr{[}ace{]} 
\srcpg{65}
The first thre forth þe \marginnote{Double t{[}ra{]}}sec{[}o{]}nd þe\\
same the 3\textsuperscript{d} the same; \red{t}hen the\\
first \marginnote{3}ma{[}n{]} outward on the left\\
shulder and goo behend þe 2\textsuperscript{d}\\
the same the 3\textsuperscript{d} þe same; \marginnote{3}\red{t}hen\\
the first out þe 2\textsuperscript{d} out þe 3\textsuperscript{d} out

\subsection{New Year}
After the\marginnote{New yer de t{[}ri{]}b{[}us{]}} end of the t{[}ra{]}ce þe firste\\
ma{[}n{]} iij forth the \marginnote{A doble tr{[}ac{]}e}2\textsuperscript{d} þe same þe 3\textsuperscript{d}\\
the same; \red{t}hen al togeder halfe\\
torne thre tymes; \marginnote{$\frac{3}{3}$}\red{t}hen the last\\
thre forth the sec{[}o{]}nd the same þe\\
3\textsuperscript{d} þe same; \marginnote{3}\red{a}nd then al togedeer\\
half torne

\subsection{Roye}
\marginnote{Roye de 3 b{[}us{]}}After the end of þ{[}e{]}\\
trace the first man thre furth\\
the sec{[}o{]}nd the \marginnote{A doble t{[}ra{]}ce \& iij bak i{[}n{]} þ{[}e{]} en{[}d{]}} same þe iij the sam\\
then al rak togeders forth; \red{t}hen\\
bak rak Ayen and all torn toged\\
\red{t}hen the first man move þen þe\\
sec{[}o{]}nd and\marginnote{3} þe 3\textsuperscript{d} move \& þe first ma{[}n{]} 
\srcpg{66}
\marginnote{2} torne Abought; \red{t}hen þe sec{[}o{]}nd ma{[}n{]}\\
me{[}v{]}e; the first and þe \marginnote{3}last meve\\
...
\subsection{Orange}
\marginnote{Oringe de 3 b{[}us{]}}After the end of þe trace the\\
first iij forth; þe 2\textsuperscript{d} þe same þe\\
3\textsuperscript{d} the same;\marginnote{A doble t{[}ra{]}ce \& lok at þ{[}e{]} end bak and al to{[}ge{]}d{[}er{]} do obbey} \red{t}hen {[}þe{]} first man\\
...
thre forth the \marginnote{3} fi{[}r{]}st þe same þe 2\textsuperscript{d}\\
þe sam \& the \marginnote{3}3\textsuperscript{d} throth þa{[}m{]} \& goo\\
behynd; \red{t}hen þe first iij \marginnote{3}bak þ{[}en{]}\\
þe secnd iij bak; \red{t}hen all toged{[}er{]}\\
thre forth and thre bake \& t{[}or{]}ne

\srcpg{67}
\subsection{Hawthorne}
\marginnote{Hawthorne de duob{[}us{]}} Thre singlis and thre Rakkys \&\\
...
\marginnote{Newcastell de dubus}The first thre forth\\
\& torne whyls þe last retrett rek\\
the last torne \marginnote{Suff}whils þe first retrett;\\
then þe first aflo{[}ur{]} delice þe 2\textsuperscript{e} þe\\
same; \marginnote{a dubull t{[}ra{]}ce}then thre singlis a þ\textsuperscript{e} {[}con{]}tra to od{[}er{]};
\srcpg{68}
...
\subsection{Damesyn}
\marginnote{Damesyn de 3b{[}us{]}}All togedd{[}er{]} thre singlis w{[}ith{]}\\
a stope \textsuperscript{+} iij retrett \& thre forth and\\
so ij tymys; then at þe \reversemarginpar\marginnote{t{[}ra{]}ce}iij\textsuperscript{d} t{[}ra{]}ce 3\\
...
\subsection{Rawty}
\marginnote{Rawty de 2bus}Trett retrett togedd{[}er{]}s\\
then thre singlis w{[}ith{]} a stope and\\
\marginnote{A dubel {[}trace{]}}thre retrett w{[}ith{]} a stop both togedd{[}er{]}\\
...
\marginnote{Temp{[}er{]}ans} All trett and retrett thre singlis w{[}ith{]} a stop then þe first and þ{[}e{]} me=dyll togedd{[}er{]} retrett; while þe last goth \marginnote{Trace}forth and cu{[}m{]} togedd{[}er{]} agayn in the same forme sav=yng in the end wher þe laste; dep{[}er{]}tytt þe secnd shall þe thred the first shall; then ev{[}er{]}y man togedd{[}er{]} two dubles on þe left fott and halfe a torn; then ev{[}er{]}y man the same {[}con{]}tr{[}ar{]}y wyes agayn then all togedd{[}er{]} trett retrett and thre rakke then all toged{[}er{]} aflo{[}ur{]} delice; then þe first ma{[}n{]} throw whils þe tothir two cha=nge place; then þe first 3 forth w{[}ith{]} a torn þe 2\textsuperscript{d} þe same þe 3 þe same w{[}ith{]} out a torn then the 
\srcpg{71} 
first lepe the secnd lepe þe last lepe; then all torn w{[}ith{]} a rest in the meddys

\subsection{Northumberland}
\marginnote{Northhu{[}m{]}bland de 3{[}bus{]}}Togedd{[}er{]} thre si{[}n{]}g=lis w{[}ith{]} a stop trett and retrett; then þe first \sout{þ} ma{[}n{]} torn in hys own place whill the last \marginnote{Trace}torn the medyll abowytt; togedd{[}er{]} agayn w{[}ith{]} thre singlis and a stop trett and retrett; then halfe a torn and torn agayn 3 toge=dd{[}er{]} then agay w{[}ith{]} thre singlis and a stope \& trett and retrett then þe first; torn þe meddyll abowt whils þe last ma{[}n{]} torn in his own place; then ev{[}er{]}y man a mevyng; then þe first and the last torn owtward go=yng forth vj singlis the 2\textsuperscript{d} forth \srcpg{72} right torn all face to face and þ\textsuperscript{e} thred brayll þe toþ\textsuperscript{e} two cu{[}m{]} to hy{[}m{]} and goo to þ\textsuperscript{e} place agay{[}n{]}; then þe 3\textsuperscript{d} and þe 2\textsuperscript{d} brayll the; meddyll cu{[}m{]} to þem and go to his awn place agayn; then the first and þe last lepe to gedd{[}er{]} þe meddyll lepe alone; then þe meddyll throw whils othir two hym t{[}ur{]}nyg all face to face; All at onys aflo{[}ur{]} delice the first and þe meddyl rak tell þay mett whill þe last; retrett; aflo{[}ur{]} delice at onys þe meddell and þe last rake whil þay mett while the first retrett than all cu{[}m{]} togedder
