...
\marginnote{P{[}re{]}nes a gard de trib{[}us{]}}Af{[}er{]} the end of the\\
...
lepe þe \marginnote{A doble tr{[}ac{]}e}medill torne; \red{t}hen þe\\ 
the medill forth iij singlis w{[}t{]}\\
halfe a torne whill þe first and the\\
last \marginnote{3}retrett; \red{t}hen the first\\
torne þ{[}e{]} last lepe; \red{t}hen þe me-\\
dill ma{[}n{]} throth whill þe first \&\\
the last change place\marginnote{1} and the\\
medill to his place Agayn; \red{t}hen\\
the first t{[}or{]}ne retrett \& rake\\
\srcpg{60}\marginnote{3} whill \^{} \textsuperscript{þe 2{[}d{]}} t{[}or{]}ne rake and retrett and þ{[}e{]}\\
third retret rake \& torne then Al\\
at onys a flour dilice \& com to-\\
geders;

\subsection{Pernes on Gre}
\marginnote{Pernes on gre de 2{[}o{]}bs}Trace forth right vj\\
singlis ather torne oy{[}er{]} aboute \&\\
forth right vj singlis ayen; Aft{[}er{]}\\
the end of þe trace rak \marginnote{The t{[}ra{]}ce}both to-\\
ged{[}er{]} and torne; \red{t}hen face to face\\
vj singlis \marginnote{3} ethir {[}con{]}t{[}ra{]}ry od{[}er{]} and iij\\
retrette Ayen; \red{t}hen A\marginnote{4} flowr deli\\
of both at onys; \red{t}hen change place\\
and torne face to face; \red{t}hen A flowr\\
delice and come \marginnote{1}toged{[}er{]};

\subsection{Princitore}
\marginnote{Princitore}After þe\\
end of þe trace A longe torne both\\
at onys; \red{t}hen þe first \marginnote{De duob{[}us{]}}ma{[}n{]} iij forth\\
and þe od{[}er{]} iij bak and then loke\\
ov{[}er{]} \marginnote{Whith t{[}ra{]}ce}þe shuldyr the secnd ma{[}n{]} þe\\
same whill þe first ma{[}n{]} followith\\
hyme in the same forme w{[}t{]}\\
obeysaunce at þe last end thus \srcpg{61}
doo thre tymes and at þe thred ty{[}m{]}\marginnote{3}\\
...
\subsection{Armyn}
\marginnote{Armyn de 3{[}bus{]}}After the end\\
of þe trace the last iij bak þe med-\\
lis od{[}er{]} iij bak \marginnote{A doble t{[}ra{]}ce}the first od{[}er{]} iij bake\\
\red{t}hen þe first meve þe secnd half\\
torne þe secnd move \& þe last\\
half torne the last move \marginnote{3}and þ{[}e{]}\\
first halfe torne; \red{t}hen þe last\\
vi singlis \marginnote{2}forth þe meddist as\\
many to hym; \red{t}hen þe first trett\\
retret \marginnote{1}and torne as he standith\\
\red{t}hen brawle al at onys on way \&\\
ayen\marginnote{3} the od{[}er{]} way; \red{t}hen ev{[}er{]}y ma{[}n{]} at\\
onys change place;\marginnote{2} \red{t}hen þe last\\
