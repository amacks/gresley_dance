...
MusicTwoTwo = \relative c {
			...
			\bar "|" \noBreak
			a1 a2 a1 a2 
			g1^\tweak #'font-size #-5 \signumcongruentiae
...
MusicTwoThree = \relative c {
			...
			c1 c2 c2 b1 a1.^\tweak #'font-size #-5 \signumcongruentiae 
			\override Staff.Clef.full-size-change = ##t
			\clef "petrucci-c4"
...
MusicFiveOne = \relative c {
			...
			\bar "|"
			d1 c1^\tweak #'font-size #-5 \signumcongruentiae d1 c1
			\bar "|"
...
MusicFiveTwo = \relative c' {
			...
			d1 c1^\tweak #'font-size #-5 \signumcongruentiae d1 c1
			\bar "|" \noBreak
			f1. g1. a1. a1^\tweak #'font-size #-5 \signumcongruentiae 
			a2 g2 f2 g\breve
			\bar "|" \noBreak
...
MusicFiveThree = \relative c' {
			...
			\bar "|" \noBreak 
			e1 f1^\tweak #'font-size #-5 \signumcongruentiae d1 c\breve
			\bar "|" \noBreak 
...
MusicSevenThree = \relative c' {
			\key f \major
			\cadenzaOn
			e1. f2 e2 d4 c4 bes2 a2 
			c1 d2 f2 e2 e2 d4 c4 bes2 a2
			\bar "|"  \noBreak
			c2. d4 e2 f2 g1 e1 f2 d2 e1 d\breve
			\bar "|"  \noBreak
			e1 f1 a1 g2 e1 f2 g1. e1
			\bar "|" \noBreak
			e1. f2 e2 d4 c4 bes2 a2
			c2 d2 f2 e2 e2 
...
\markup { 
	...
	\hspace #0
	\wordwrap \small { \italic { Comment 2: } I suggest that the small symbol appearing above lines two and three is a \italic {signum congruentiae.}  Such symbols were common in 15th- and 16th-century music; they have a variety of appearances and many meanings, which often have to do with repeat structure.}  
		\hspace #0
	\wordwrap\small {"       \""... the renaissance \italic {signum congruentiae} is a notorious and constant source of confusion on account of its variable meaning, and editors would do well to indicate its presence prominently wherever there is a possibility of ambiguity."\"" (Warwick Edwards (1978). English Sacred Music (Review). \italic{Early Music} Vol. 6, No. 4, 607-609.)
	\wordwrap\small {"      "For a discussion of the  \italic {signum congruentiae} as an indicator of repeats in monophonic music of the late 15th century, see Maureen Epp (2009), \italic{Reading the Signs: Notation and Performance in the French Popular Song Repertory.}  In \underline{The Sounds and Sights of Performance in Early Music} (pp. 103-122), Maureen Epp and Brian Power (Eds.) Burlington VT; Ashgate Publishing.}
...
\markup { 
	...
	\wordwrap \small { \italic { Comment 1:} Some of the ink 
...
\markup { 
	...
	\wordwrap \small { \italic { Comment 3: } I suggest that the small symbols appearing above the staves are \italic {signa congruentiae.}}
	\wordwrap \small { \italic { Comment 4:} There are several
...
\markup { 
	...
	\wordwrap \huge { \with-color #white "Spacer text" }
	\hspace #0
	\wordwrap \small { \italic { Comment: } The last note on the third staff is squeezed in at the edge of the page and partly scratched away.}  
	\hspace #0
} }
